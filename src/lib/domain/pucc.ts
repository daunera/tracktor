...
const pollutionCertificateBaseSchema = z.object({
...
export const pollutionCertificateSchema = pollutionCertificateBaseSchema.refine(
  (data) => {
...
export const pollutionCertificatePartialSchema = pollutionCertificateBaseSchema.partial();
