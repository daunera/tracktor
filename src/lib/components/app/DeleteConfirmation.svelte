...
{#if open}
  ...
  >
    <div
      ...
      class="delete-confirmation-dialog dark:bg-card flex max-h-[90vh] w-[80vh] max-w-[400px] max-w-xl min-w-0 flex-col items-center justify-center overflow-y-auto rounded-lg bg-white p-8 shadow-2xl sm:w-auto sm:min-w-sm"
    >
